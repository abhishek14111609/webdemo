                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                           id="slug" name="slug" value="{{ old('slug', $category->slug) }}" placeholder="Leave empty to auto-generate">
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($category->image)
                                        <div class="form-text">
                                            Current image: <a href="{{ asset('storage/' . $category->image) }}" target="_blank">View</a>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <div id="image-preview" class="mb-3" style="{{ $category->image ? 'display: block;' : 'display: none;' }}">
                                            ...
                                            <div id="no-image" class="mb-3" style="{{ $category->image ? 'display: none;' : 'display: block;' }}">
